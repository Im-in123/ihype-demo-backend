...
#                 return Response({"error":"Token aint valid, please request a new one"}, status = 200)
#             return Response({"success":True, "message":"Credentials is valid", "uidb64":uidb64, "token":token})

#         except DjangoUnicodeDecodeError as e:
#             print("password token check::::", e)
#             return Response({"error":"Token aint valid, please request a new one"}, status = 401)
